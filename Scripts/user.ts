...
namespace core {
    export class User {
        ...
        public set DisplayName(displayName:string){this.m_displayName = displayName;}

        public set EmailAddress(emailAddress:string){this.m_emailAddress = emailAddress;}

        public set Username(username:string){this.m_username = username;}

        public set Password(password:string){this.m_password = password;}
